//! DXGI desktop duplication capture (Windows). Returns tightly packed BGRA.
...
impl DesktopCapture {
    ...
    /// Blocks until the next frame. Returns tightly packed BGRA (`width*height*4`).
