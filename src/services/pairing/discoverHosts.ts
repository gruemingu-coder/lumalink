/**
 * LAN auto-discovery for real LumaLink Host apps. Only available from
 * the LumaLink Streaming *desktop* app (Tauri) — browsers have no API
...
/** Listens for `timeoutMs` and returns whatever LumaLink Hosts announced themselves. */
